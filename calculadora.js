...
function anterior() {
    ...
    alert("Seu último histórico é: \n" + ultimo);

}

function troca() {
    var input1 = document.getElementById('valora').value;
    var input2 = document.getElementById('valorb').value;

    document.getElementById('valora').value = input2
    document.getElementById('valorb').value = input1
}
function limpar() {
    var input1 = (document.getElementById("valora").value = "");
    var input2 = (document.getElementById("valorb").value = "");
...
function zerar() {
    var input1 = (document.getElementById('valora').value = "0");
    var input2 = (document.getElementById('valorb').value = "0");
}
